...
Fiz o uso da biblioteca do python de testes, o unittest, para fazer os testes das funções da business. Por enquanto só fiz o teste de dados de entrada e saída do arquivo Appointment_business, sem fazer a cobertura de erros e do arquivo Professional_business.
